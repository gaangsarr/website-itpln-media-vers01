            ...
            <ScrollAnimationWrapper animation="fadeInUp" delay={200}>
              <div className="max-w-3xl mx-auto">
                <p className="text-lg sm:text-xl text-purple-100 leading-relaxed mb-12">
                  ...
                  memukau! Dengan tema "Data Science Untuk Kebutuhan Energi
                  Bersih Nuklir," tunjukkan bagaimana data sains dapat berperan
                  dalam pengembangan energi nuklir yang bersih dan
                  berkelanjutan.
                </p>
              </div>
            </ScrollAnimationWrapper>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>
                      ...
                      students or University students (D3/S1) in Indonesia.
                    </li>
                    ...
                    <li>
                      • Logo: Must include the official ITPLN Media logo
                    ...
                    <li>
                      • Instagram Post: Upload to personal, public Instagram
                      account with:
                      <ul>
