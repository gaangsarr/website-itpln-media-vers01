            ...
            <ScrollAnimationWrapper animation="fadeInUp" delay={200}>
              <div className="max-w-3xl mx-auto">
                <p className="text-lg sm:text-xl text-purple-100 leading-relaxed mb-12">
                  Desain masa depan energi bersih melalui antarmuka aplikasi
                  yang inovatif! Wujudkan konsep aplikasi edukasi/informasi
                  dengan tema "Data Science Untuk Kebutuhan Energi Bersih
                  Nuklir." Tunjukkan keahlianmu dalam menciptakan pengalaman
                  pengguna yang mulus dan visual yang menarik.
                </p>
              </div>
            </ScrollAnimationWrapper>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>
                      ...
                      be individual or team (max 2 members).
                    </li>
                    <li>
                    ...
                    <li>
                      • Tools: Figma, Adobe XD, or similar UI/UX design
                      software.
                    </li>
                    <li>
                      • Resolution: Recommended 1080x1920 px (for mobile
                      display).
                    </li>
                    <li>
                    ...
                    <li>
                      • Copyright: All design assets must not violate
                      copyrights.
                    </li>
                    <li>
                      • Submission Files: Interactive prototype link, 3-5 main
                      screens (JPG/PNG), and optional PDF concept presentation
                      (max 5 pages).
                    </li>
                    <li>
                      ...
                      <ul>
                        <li>
                          ...
                          explaining concept, features, and educational value.
                        </li>
                        <li>
              ...
              <ScrollAnimationWrapper animation="fadeInRight" delay={300}>
                <div>
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li>
                      • Prototype Link (Figma/Adobe XD, etc. - ensure public
                      access)
                    </li>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <ScrollAnimationWrapper animation="fadeInUp" delay={200}>
            <p className="text-xl mb-8">
              Join the National Creative Competition and showcase your UI design
              skills!
            </p>
          </ScrollAnimationWrapper>
