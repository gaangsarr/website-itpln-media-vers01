          ...
          <div className="text-center">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg sm:text-xl text-purple-100 leading-relaxed mb-12">
                Desain masa depan energi bersih melalui antarmuka aplikasi yang
                inovatif! Wujudkan konsep aplikasi edukasi/informasi dengan tema
                "Data Science Untuk Kebutuhan Energi Bersih Nuklir." Tunjukkan
                keahlianmu dalam menciptakan pengalaman pengguna yang mulus dan
                visual yang menarik.
              </p>
            </div>
