          ...
          <div className="text-center">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg sm:text-xl text-purple-100 leading-relaxed mb-12">
                Jadikan media sosial sebagai panggung karyamu! Buat video Reels
                berdurasi 30-60 detik yang kreatif dan informatif dengan tema
                "Data Science Untuk Kebutuhan Energi Bersih Nuklir." Sampaikan
                pesan yang jelas dan menginspirasi, dengan kualitas visual dan
                audio yang memukau.
              </p>
            </div>
